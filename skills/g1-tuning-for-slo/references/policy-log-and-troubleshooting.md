...
- JDK 25 IHOP statistics log `heap.used()` as `current occupancy`, not the trigger's non-young
  occupancy. The printed 45% is threshold/target. Read `gc+ergo+ihop` for trigger occupancy.
...
Source anchors for the JDK 25 log interpretation:
[G1IHOPControl](https://github.com/openjdk/jdk/blob/jdk-25-ga/src/hotspot/share/gc/g1/g1IHOPControl.cpp)
and [G1Policy](https://github.com/openjdk/jdk/blob/jdk-25-ga/src/hotspot/share/gc/g1/g1Policy.cpp).
