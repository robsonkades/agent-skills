...
| ------------------------------------- | --------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `-XX:+UseG1GC`                        | ergonomic default since JDK 9 (JEP 248)       | Selects G1                                                                                                                                                                         | Explicit selection makes intent independent of ergonomics. JDK 27 EA documentation says G1 is the default; JEP 523 is still Candidate, so verify the exact vendor/build rather than treating the proposal as delivered — `jvm-gc-tuning` |
